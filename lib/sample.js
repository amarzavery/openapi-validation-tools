...
var options = {};
options.definition = 'https://raw.githubusercontent.com/Azure/azure-rest-api-specs/master/arm-search/2015-08-19/swagger/search.json';
options.jsonRefs = {};
options.jsonRefs.relativeBase = 'https://raw.githubusercontent.com/Azure/azure-rest-api-specs/master/arm-search/2015-08-19/swagger';
var swaggerApi;
Sway.create(options)
  .then(function (api) {
    swaggerApi = api;
